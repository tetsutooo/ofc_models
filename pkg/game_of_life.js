...
const GolFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_gol_free(ptr >>> 0, 1));
...
export class Gol {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        GolFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_gol_free(ptr, 0);
    }
    /**
     * @param {number} width
     * @param {number} height
     * @param {number} graph_width
     * @param {number} graph_height
     */
    constructor(width, height, graph_width, graph_height) {
        const ret = wasm.gol_new(width, height, graph_width, graph_height);
        this.__wbg_ptr = ret >>> 0;
        GolFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    display(ctx) {
        wasm.gol_display(this.__wbg_ptr, ctx);
    }
    /**
     * @param {CanvasRenderingContext2D} ctx
     * @param {number} y_row
     */
    draw_graph(ctx, y_row) {
        wasm.gol_draw_graph(this.__wbg_ptr, ctx, y_row);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_strokeRect_55d1b6a171843ecf = function(arg0, arg1, arg2, arg3, arg4) {
