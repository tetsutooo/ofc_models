...
export class Gol {
    ...
    constructor(width, height) {
        const ret = wasm.gol_new(width, height);
        this.__wbg_ptr = ret >>> 0;
        GolFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    init() {
        wasm.gol_init(this.__wbg_ptr);
    }
    generate() {
        wasm.gol_generate(this.__wbg_ptr);
    }
    /**
     ...
     * @returns {Array<any>}
     */
    get_horizontal_line_data(y) {
        const ret = wasm.gol_get_horizontal_line_data(this.__wbg_ptr, y);
        return ret;
    }
}
